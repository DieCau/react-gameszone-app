  ...
  return (
    <>
      <section>
        ...
        <div className="container my-5">
          <div className="mb-3">
            <blockquote className="fst-italic text-center text-secondary">
              Somos el equipo detrás de <b>GamerZone</b>, un grupo de
              desarrolladores apasionados por los videojuegos, la tecnología y
              la innovación. Nos especializamos en crear un catálogo de juegos
              cuidadosamente estructurado, con categorías únicas y una
              experiencia de usuario fluida e intuitiva.
            </blockquote>
          </div>
          <div className="mb-3">
            <blockquote className="fst-italic text-center text-secondary">
              Esta plataforma fue desarrollada utilizando tecnologías modernas
              como <b>React</b> para el <b>frontend</b>, junto con{" "}
              <b>Bootstrap</b> y <b>CSS</b> para el diseño responsivo.
              Implementamos buenas prácticas de desarrollo como el enrutamiento
              con <b>React Router</b>.
            </blockquote>
          </div>
          <div className="mb-3">
            <blockquote className="fst-italic text-center text-secondary">
              Nuestra <b>misión</b> es ofrecer una experiencia de navegación
              rápida, visualmente atractiva y centrada en el usuario. Creemos en
              el poder del gaming para conectar personas, contar historias y
              transformar el entretenimiento digital.
            </blockquote>
          </div>
          <div>
            <blockquote className="fst-italic text-center text-secondary">
              Seguimos aprendiendo y creciendo como equipo, comprometidos con el
              desarrollo de soluciones innovadoras y funcionales dentro del
              mundo del software y los videojuegos.
            </blockquote>
          </div>
        </div>
        {/* Fin presentacion */}
        ...
        <div className="container my-5">
          <h2 className="bebasneue display-6 text-center mb-4">
          ...
          <div className="row justify-content-center row-gap-3">
            ...
            <article className="col-6 col-md-4 col-lg-2 equipoCard">
              <div className="card border-0 shadow h-100 teamCard">
                ...
                <div className="card-main bg-white text-dark h-100 py-2">
                  <h5 className="card-title bebasneue text-center fs-4 mt-3">
                    Diego Caucota
                  </h5>
                  <p className="text-center lead card-text">
                    React Expert
                  </p>
                  <p className="roboto mx-3 text-center">
                    +5 años de experiencia desarrollando interfaces de usuario
            ...
            <article className="col-6 col-md-4 col-lg-2 equipoCard">
              <div className="card border-0 shadow h-100 teamCard">
                <img
                  src={avatar2}
                  alt="Avatar del segundo miembro del equipo"
                />
                <div className="card-main bg-white text-dark h-100 py-2">
                  <h5 className="card-title bebasneue text-center fs-4 mt-3">
                    Esteban Lozano
                  </h5>
                  <p className="text-center lead card-text">CSS Master</p>
                  <p className="roboto mx-3 text-center">
                    Diseñador de sistemas de diseño y maquetación con enfoque
                    mobile-first.
                  </p>
                </div>
                <div className="card-footer text-center bg-primary">
            ...
            <article className="col-6 col-md-4 col-lg-2 equipoCard">
              <div className="card border-0 shadow h-100 teamCard">
                ...
                <div className="card-main bg-white text-dark h-100 py-2">
                  ...
                  <p className="text-center lead card-text">Backend</p>
                  <p className="roboto mx-3 text-center">
                    Especialista en operaciones CRUD, API's y manipulación de
                    DOM/BOM.
                  </p>
                </div>
                <div className="card-footer text-center bg-primary">
            ...
            <article className="col-6 col-md-4 col-lg-2 equipoCard">
              <div className="card border-0 shadow h-100 teamCard">
                ...
                <div className="card-main bg-white text-dark h-100 py-2">
                  ...
                  <p className="roboto mx-3 text-center">
                    Especialista en seleccionar y evaluar los mejores juegos
              ...
              <div className="card border-0 shadow h-100 teamCard">
                ...
                <div className="card-main bg-white text-dark h-100 py-2">
                  ...
                  <p className="text-center lead card-text">
                    Architect</p>
                  <p className="roboto mx-3 text-center">
                    Lider técnico con experiencia en proyectos complejos de
                    JavaScript.
                  </p>
                </div>
                <div className="card-footer text-center bg-primary">
        ...
        <div className="container my-5 tecnologiasQueDominamos">
          <h2 className="bebasneue text-center mb-4 titleTecnologia">
